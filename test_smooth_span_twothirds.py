#!/usr/bin/env python
"""Test script to compare LOESS with span=2/3 (R's default)"""
...
# Create plot with default span (now 2/3)
print("Creating plot with default span=2/3...")
p = (
...
fig = p.draw()
fig.write_html('test_smooth_span_twothirds.html')
print("Saved: test_smooth_span_twothirds.html")

print("\n✓ Plot created with span=2/3 (R's default)")
