#!/usr/bin/env python
"""Test with K=0.1, compatibility_threshold=0.3, cycles=3"""
...
print("Applying edge bundling with K=0.1, threshold=0.3, cycles=3...")
p = (
    ggplot(edges_df, aes(x='x', y='y', xend='xend', yend='yend'))
    + geom_edgebundle(K=0.1, compatibility_threshold=0.3, cycles=3, alpha=0.35, width=0.6)
)
...
fig.update_layout(
    title=f"Edge Bundling: K=0.1, threshold=0.3, cycles=3",
...
fig.write_html('test_k01_threshold03.html')
print("Created: test_k01_threshold03.html")
print("✓ Done!")
