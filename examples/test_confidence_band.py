#!/usr/bin/env python
"""Test script to examine confidence band calculation"""
...
print("Testing confidence band calculation...")
smoother = stat_smooth(method='loess', span=2/3, se=True, level=0.95)
...
print("\nSample of smoothed data with confidence bands:")
print(smoothed_sorted[['displ', 'hwy', 'ymin', 'ymax']].head(15))
...
print("(Should be around 95% for 95% confidence level)")

# Create plot with confidence band
print("\nCreating plot with confidence band...")
p = (
...
fig = p.draw()
fig.write_html('test_confidence_band.html')
print("Saved: test_confidence_band.html")

print("\n✓ Confidence band test complete")
